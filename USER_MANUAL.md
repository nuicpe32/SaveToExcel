...
1. [ภาพรวมของโปรแกรม](#ภาพรวมของโปรแกรม)
2. [ความสามารถของโปรแกรม](#ความสามารถของโปรแกรม)
3. [การติดตั้งและเริ่มต้นใช้งาน](#การติดตั้งและเริ่มต้นใช้งาน)
4. [คู่มือการใช้งานแต่ละแท็บ](#คู่มือการใช้งานแต่ละแท็บ)
...
**ระบบจัดการคดีอาญา** เป็นโปรแกรม GUI ที่พัฒนาด้วยภาษา Python สำหรับหน่วยงานที่ต้องจัดการข้อมูลคดีอาญาแบบครบวงจร โดยมีการเชื่อมโยงข้อมูลระหว่างคดี บัญชีธนาคาร หมายเรียกผู้ต้องหา และการจับกุม

### 🎨 **Professional Architecture v2.4.0**
โปรแกรมได้รับการรีแฟกเตอร์ให้มีสถาปัตยกรรมแบบมืออาชีพ แยกส่วนการทำงานอย่างชัดเจน ทำให้ง่ายต่อการดูแลรักษาและเพิ่มฟีเจอร์ใหม่
