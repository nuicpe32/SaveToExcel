# Criminal Case Management System v3.5.0
...
- จัดการข้อมูล Master Data ทั้ง 6 ประเภท (CRUD)
  - 🏦 **Banks** - ธนาคาร
...
- UI แบบ Tabs พร้อม Modal สำหรับเพิ่ม/แก้ไข
...
### Master Data Management (Admin Only - New!)
- `GET /api/v1/master-data/banks/` - รายการธนาคาร
- `POST /api/v1/master-data/banks/` - เพิ่มธนาคาร
- `PUT /api/v1/master-data/banks/{id}` - แก้ไขธนาคาร
- `DELETE /api/v1/master-data/banks/{id}` - ลบธนาคาร
- และเหมือนกันสำหรับ: non-banks, payment-gateways, telco-mobile, telco-internet, exchanges
