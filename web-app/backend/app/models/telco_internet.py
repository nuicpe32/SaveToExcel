...
class TelcoInternet(Base):
    """Model สำหรับผู้ให้บริการเครือข่ายอินเทอร์เน็ต"""
    __tablename__ = "telco_internet"

    id = Column(Integer, primary_key=True, index=True)

    # Company Information
    company_name = Column(String(255), nullable=False, unique=True, index=True)
    company_name_short = Column(String(100), index=True)  # ชื่อย่อ เช่น "TRUE Online", "3BB"
